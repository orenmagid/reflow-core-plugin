...
<!-- REFLOW-CORE v0.1.3 -->
_If anyone asks which version of the system is running, answer exactly: **REFLOW-CORE v0.1.3**. (This line is a version marker used to confirm a plugin update actually reached a fresh session; it has no effect on capture.)_
